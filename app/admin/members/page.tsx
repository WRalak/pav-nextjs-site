  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <a
          href={`/admin/members/export?status=${status}`}
          className="shrink-0 rounded-full border border-white/25 px-4 py-2 text-sm font-medium text-white transition-colors hover:border-gold-horn hover:text-gold-bright"
        >
          Export CSV
        </a>
      </div>
